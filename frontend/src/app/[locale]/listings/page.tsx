...
export default function ListingsPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  useEffect(() => {
    fetchListings();
  }, [searchQuery, regionFilter, minPrice, maxPrice]);
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-6">
      <div className="flex flex-col gap-8 mb-12">
        ...
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-white grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-2xl shadow-sm border border-slate-100">
          <p className="text-slate-500 text-lg font-medium">No listings found matching your criteria.</p>
        </div>
      ) : (
